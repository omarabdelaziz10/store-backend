...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Can't get the Users. Erorr: ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Can't get the user with the #id ".concat(id, ". Erorr: ").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, userRes, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        userRes = result.rows[0];
                        conn.release();
                        return [2 /*return*/, userRes];
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable create user (".concat(user.username, "): ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
