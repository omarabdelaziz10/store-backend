        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (order) {
                    ...
                    res.status(404).send("order with id ".concat(id, " is not Found"));
                }
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var status_1, user_id, order, orderRes, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                if (status_1 === undefined || user_id === undefined) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.getCurrentOrders(userId)];
            case 1:
                orders = _a.sent();
                res.status(200).json(orders);
                return [3 /*break*/, 3];
            case 2:
                ...
                if (error_4 instanceof Error) {
                    res.status(400).json(error_4.message);
                }
...
var addProductToOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order_id, product_id, quantity, orderDetails, orderRes, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, store.addProduct(orderDetails)];
            case 1:
                orderRes = _a.sent();
                res.status(201).json(orderRes);
                return [3 /*break*/, 3];
            case 2:
                ...
                if (error_5 instanceof Error) {
                    res.status(400).json(error_5.message);
                }
...
var orderHandler = function (app) {
    app.get('/orders', jwtAuth_1.verifyToken, index);
    app.get('/orders/:id', jwtAuth_1.verifyToken, show);
    app.post('/orders', jwtAuth_1.verifyToken, create);
    app.get('/orders/user-orders/:userId', jwtAuth_1.verifyToken, ordersByUser);
    app.post('/orders/:orderId/product', jwtAuth_1.verifyToken, addProductToOrder);
};
