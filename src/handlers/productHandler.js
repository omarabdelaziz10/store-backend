        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (product) {
                    ...
                    res.status(404).send("product with id ".concat(id, " is not Found"));
                }
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, price, product, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, store.create({ name: name_1, price: price })];
            case 1:
                product = _a.sent();
...
var productHandler = function (app) {
    ...
    app.post('/products', jwtAuth_1.verifyToken, create);
};
