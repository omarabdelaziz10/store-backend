        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (user) {
                    ...
                    res.status(404).send("User with id ".concat(id, " is not Found"));
                }
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var first_name, last_name, username, password, user, userRes, token, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                if (first_name === undefined ||
                    ...
                    res
                        .status(400)
                        .send('Some required parameters are missing! first_name, last_name, username, password');
                    return [2 /*return*/];
                }
                user = {
            ...
            case 1:
                userRes = _a.sent();
                token = jsonwebtoken_1["default"].sign({ user: userRes }, TOKEN_SECRET);
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, password, user, token, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var userHandler = function (app) {
    app.get('/users', jwtAuth_1.verifyToken, index);
    app.get('/users/:id', jwtAuth_1.verifyToken, show);
